...
const NEWS_ORG_API = "https://newsapi.org/v2/everything";
const NEWS_ORG_API_KEY = import.meta.env.VITE_NEWSAPI_ORG_API_KEY;
 ...
 */
export const getArticlesFromNewsOrgAPI = async (
  query: string,
  date?: Date,
  category?: Category
): Promise<News[]> => {
