...
const GAURDIAN_API = "https://content.guardianapis.com/search";
const GAURDIAN_API_KEY = import.meta.env.VITE_GUARDIAN_NEWS_API_KEY;
 ...
 */
export const getArticlesFromGuardianAPI = async (
  query: string,
  date?: Date,
  category?: Category
): Promise<News[]> => {
